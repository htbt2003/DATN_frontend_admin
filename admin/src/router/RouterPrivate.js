...
import ProductSaleList from "../views/admin/ProductSale/ProductSaleList";
...
//   { path: "/admin/contact/response/:id", component: ContactResponse },
  ...
  { path: "/admin/order", component: OrderList, component:ProductStoreList, name:'Hóa đơn', parent:'QLBH' },
