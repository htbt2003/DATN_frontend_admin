  ...
  return (
    ...
    >
      ...
      <ul className="mb-auto pt-1">
        ...
        <div className="relative mb-3 hover:cursor-pointer" onClick={() => setGiaoDien(prevState => !prevState)}>
          <li className="my-[3px] cursor-pointer items-center px-8">
              <div className="flex items-center justify-between">
        ...
        <div className="relative mb-3 hover:cursor-pointer" onClick={() => setHeThong(prevState => !prevState)}>
          <li className="my-[3px] cursor-pointer items-center px-8">
              <div className="flex items-center justify-between">
