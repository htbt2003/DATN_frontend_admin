...
function PageUpdate() {
    ...
    return (
<form method='post' onSubmit={PageEdit} className="mt-8">
      <div className="content">
        <section className="content-header my-2">
          <strong className="inline-block text-3xl text-navy-700 dark:text-white">Cập nhật trang đơn</strong>
