...
function PostCreate() {
  ...
  return (
<form method='post' onSubmit={PostStore} className="mt-8">
      <div className="content">
        <section className="content-header my-2">
          <strong className="inline-block text-3xl text-navy-700 dark:text-white">Thêm trang đơn</strong>
            ...
            <div className="md:col-span-3">
              <div className="bg-white p-5 rounded-xl">
                ...
                <div className="mb-3">
                  ...
                  <TinyMCE setValue={setDetail} placeholder="Nhập chi tiết bài viết" />
                </div>
                <div className="mb-3">
                  <label>
                    <strong>Mô tả (*)</strong>
