...
const Product = ({ setProductSelecteds, setShowProduct, funtionApi, setReloadIndex }) => {
    ...
    return (
        <>
            ...
            {
                showVariant ? (
                    <Variant product={product} setShowVariant={setShowVariant} setProductSelecteds={setProductSelecteds} setReloadIndex={setReloadIndex}/>
                ) : null
            }
        </>
    );
